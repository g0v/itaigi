...
export default Transmit.createContainer(LaiLik, {
  queries: {
    laiLikData ({laiLikId}) {
      ...
      return superagent.get('http://127.0.0.1:8000/%E5%B9%B3%E8%87%BA%E9%A0%85%E7%9B%AE%E4%BE%86%E6%BA%90/%E7%9C%8B%E5%85%A7%E5%AE%B9?%E4%BE%86%E6%BA%90%E7%B7%A8%E8%99%9F=' + laiLikId)
        .then((res) => res.body)
    }
  }
})
