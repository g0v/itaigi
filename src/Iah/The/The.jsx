      ...
      <div className='main container'>
        <div className='the content'>
          <div className='ui forum segment'>
            ...
            <ABo 華語關鍵字={this.props.params.k} 後端網址={this.props.後端網址} csrftoken={this.props.csrftoken} 編號={this.props.編號} 漢字={this.props.location.query.漢字} 音標={this.props.location.query.音標}/>
          </div>
        </div>
      </div>
    );
