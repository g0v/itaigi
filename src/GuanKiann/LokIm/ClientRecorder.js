...
var MainWorkerScript = require("raw!./RecordWorker.js")
var EncoderWorkerScript = require("raw!./mp3Worker.js")
var EncoderWorkerScript = "" 
var testScript = require("raw!./SimpleWorker.js")
...
export default class ClientRecorder {
  constructor(source, cfg){
      ...
      var worker = new Worker(window.URL.createObjectURL(new Blob([ MainWorkerScript ])));
      window.worker = worker
      var encoderWorker = new Worker(window.URL.createObjectURL(new Blob([EncoderWorkerScript])));
      worker.postMessage({
        command: 'init',
       config: {
